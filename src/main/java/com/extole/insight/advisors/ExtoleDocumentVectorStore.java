...
@Component
public class ExtoleDocumentVectorStore {
    private SimpleVectorStore simpleVectorStore;
    private File storeFile;
    
    public ExtoleDocumentVectorStore(SimpleVectorStoreService simpleVectorStoreService) {
        this.simpleVectorStore = simpleVectorStoreService.getStore("extole-documents"); 
        this.storeFile = new File("/tmp/extole-documents-store.json");
    ...
    private void createStore() {   
        ...
        try {
            Path files = Paths.get(System.getenv("AI_HOME"), "/extole/documents");
